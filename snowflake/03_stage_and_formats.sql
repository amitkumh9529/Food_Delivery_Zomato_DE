...
CREATE OR REPLACE FILE FORMAT FD.RAW.CSV_FMT
  TYPE = 'CSV'
...
CREATE OR REPLACE STAGE FD.RAW.FD_RAW_STAGE
  STORAGE_INTEGRATION = FD_S3_INT
  URL = 's3://food-delivery-pipeline-ah/raw_data/'
  FILE_FORMAT = FD.RAW.CSV_FMT;

-- Confirm Snowflake can see your files (should list the seven table folders).
LIST @FD.RAW.FD_RAW_STAGE;